        ...
        <f:Panel ID="Panel1" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region">
            <Items>
                <f:Panel runat="server" ID="panelCenterRegion" RegionPosition="Center"
                    Title="总部退货作业信息" ShowBorder="true" ShowHeader="true" BodyPadding="5px">
                    <Toolbars>
                    ...
                    <Items>
                       <f:Panel ID="Panel12" runat="server" Title="退货出货作业子表">
                           <Toolbars>
                           ...
                           <Items>
                              <f:Grid ID="Grid2" Title="退货入库作业子表" EnableFrame="false" EnableCollapse="true" ShowHeader="false" runat="server" Height="600px"
