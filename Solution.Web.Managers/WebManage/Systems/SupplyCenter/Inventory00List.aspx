        ...
        <f:Panel ID="Panel1" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region">
            <Items>
                ...
                <f:Panel runat="server" ID="panelLeftRegion" EnableFrame="false" RegionPosition="Right" RegionSplit="true" EnableCollapse="true" Expanded="false"
                    ...
                    <Items>
                       <f:Grid ID="Grid1" Title="领用作业列表" ShowHeader="false" ShowBorder="false" runat="server" DataKeyNames="INV_ID"
                         ...
                         <Columns>
                           <f:RowNumberField />
                           <f:BoundField Width="125px" DataField="INV_ID" HeaderText="领用单号" />
