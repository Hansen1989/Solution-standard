        ...
        <f:Panel ID="Panel1" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region">
            <Items>
                <f:Panel runat="server" ID="panelCenterRegion" RegionPosition="Center"
                    Title="总部出货作业信息" ShowBorder="true" ShowHeader="true" BodyPadding="5px">
                    <Toolbars>
                        ...
                        <Rows>
                            ...
                            <f:FormRow ColumnWidths="300px">
                                <Items>
                                    ...
                                    <f:DatePicker ID="dpEXPECT_DATE" Label="期望时间" Required="true" Readonly="false" DateFormatString="yyyy-MM-dd" runat="server" ShowRedStar="True" Enabled="false">
                                    </f:DatePicker>
                                </Items>
                            </f:FormRow>
                    ...
                    <Items>
                       <f:Panel ID="Panel12" runat="server" Title="出货作业字表">
                           ...
                           <Items>
                              <f:Grid ID="Grid2" Title="出货子表" EnableFrame="false" EnableCollapse="true" ShowHeader="false" runat="server" Height="600px"
