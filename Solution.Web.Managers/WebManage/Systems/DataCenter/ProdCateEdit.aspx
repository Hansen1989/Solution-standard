<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProdCateEdit.aspx.cs" Inherits="Solution.Web.Managers.WebManage.Systems.DataCenter.ProdCateEdit" %>
            ...
            <f:Panel ID="Panel2" runat="server" EnableFrame="false" BodyPadding="5px" EnableCollapse="True" ShowHeader="False" ShowBorder="False">
                <Items>
                    <f:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false"
                        ...
                        <Items>
                            <f:TextBox runat="server" Label="类别编号" ID="CATE_ID" ShowRedStar="true" Width="250px" EmptyText="类别编码"></f:TextBox>
                            <f:TextBox runat="server" Label="性质名称" ID="CATE_NAME" ShowRedStar="true" Width="400px" EmptyText="类别名称" ></f:TextBox>
                            ...
                            <f:DropDownList Label="隶属中类类选择" AutoPostBack="true" Required="true" CompareType="String"
                                EnableSimulateTree="true" runat="server" ID="DEP_ID" Width="250px">
                            </f:DropDownList>
                            <f:TextBox runat="server" Label="备注" ID="CATE_MEMO" Width="400px" EmptyText="备注" ></f:TextBox>
