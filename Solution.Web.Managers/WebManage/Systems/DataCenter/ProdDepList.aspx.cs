...
{
    public partial class ProdDepList : PageBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                //PROD_KINDBll.GetInstence().BandDropDownListShowKind(this, (System.Web.UI.WebControls.DropDownList)Grid1.Rows[0].FindControl("KIND_ID"));
                //BindDropDownList();
                LoadData();
            }
        }
        private void BindDropDownList()
        {
            ...
            //majors.Add("005");
            //majors.Add("006");
            //PROD_KINDBll.GetInstence().BandDropDownListShowKind(this, sKIND_NAME);
            //sKIND_NAME.DataSource = majors;
            //sKIND_NAME.DataBind();
        }
        ...
        public override void LoadData()
        {
            ...
            //List<ConditionFun.SqlqueryCondition> conditionProdDepAllList = new List<ConditionFun.SqlqueryCondition>();
            //绑定Grid表格
            //conditionList = null;
        ...
        public void Sort()
        {
            ...
            sortList.Add(V_PROD_DEPTable.Id);
        ...
        {
            Window1.IFrameUrl = "ProdDepEdit.aspx?" + MenuInfoBll.GetInstence().PageUrlEncryptString();
