...
{
    public partial class SHOP00List : PageBase
    {
        ...
        public void Sort()
        {
            ...
            sortList.Add(SHOP00Table.Id + " asc");
        ...
        {
            Window1.IFrameUrl = "SHOP00Edit.aspx?" + MenuInfoBll.GetInstence().PageUrlEncryptString();
            Window1.Hidden = false;
        }
        #endregion
        ...
        public override void Edit()
        {
            ...
            Window1.IFrameUrl = "SHOP00Edit.aspx?Id=" + id + "&" + MenuInfoBll.GetInstence().PageUrlEncryptStringNoKey(id);
            Window1.Hidden = false;
        }
        #endregion
