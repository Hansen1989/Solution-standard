<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PagePowerSignEdit.aspx.cs" Inherits="Solution.Web.Managers.WebManage.Systems.Powers.PagePowerSignEdit" %>
            ...
            <f:Panel ID="Panel2" runat="server" EnableFrame="false" BodyPadding="5px" EnableCollapse="True" ShowHeader="False" ShowBorder="False">
                <Items>
                    <f:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false"
                        ...
                        <Items>
                            <f:TextBox runat="server" Label="部门ID" ID="txtId" ShowRedStar="true" Width="250px"></f:TextBox>
