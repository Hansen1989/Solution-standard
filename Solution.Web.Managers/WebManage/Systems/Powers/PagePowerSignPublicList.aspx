...
<body>
    ...
    <f:panel id="Panel1" runat="server" title="菜单(页面)列表" enableframe="false" bodypadding="10px"
        ...
        <items>
            ...
            <f:Grid ID="Grid1" Title="公共页面权限列表" EnableFrame="false" EnableCollapse="true" AllowSorting="true" SortField="Depth" SortDirection="ASC" 
           ...
           >  <%-- OnPageIndexChange="Grid1_PageIndexChange"  OnRowCommand="Grid1_RowCommand" OnPreRowDataBound="Grid1_PreRowDataBound"--%>  
                <Columns>
                    <f:RowNumberField />
                    <f:BoundField Width="80px" DataField="Id" DataFormatString="{0}" HeaderText="ID" />
                    <f:BoundField Width="120px" DataField="CName" DataFormatString="{0}" HeaderText="中文名称" />
