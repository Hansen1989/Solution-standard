<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenuInfoList.aspx.cs" Inherits="Solution.Web.Managers.WebManage.Systems.Powers.MenuInfoList" %>
...
<body>
    ...
    <f:window id="Window1" width="480px" height="340px" icon="TagBlue" title="编辑" 
        enablemaximize="True" closeaction="HidePostBack" onclose="Window1_Close" enablecollapse="true" hidden="True" 
        runat="server" enableresize="true" bodypadding="5px" enableframe="True" iframeurl="about:blank" Target="Parent"
        enableiframe="true" enableclose="true" ismodal="True" > <%--plain="false"  --%>
    </f:window>
