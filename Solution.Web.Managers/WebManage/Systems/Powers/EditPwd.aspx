<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPwd.aspx.cs" Inherits="Solution.Web.Managers.WebManage.Systems.Powers.EditPwd" %>
            ...
            <f:Panel ID="Panel2" runat="server" EnableFrame="false" BodyPadding="5px" EnableCollapse="True" ShowHeader="False" ShowBorder="False">
                <Items>
                    <f:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false"
                        ...
                        <Items>
                            <f:TextBox runat="server" Label="新密码" ID="txtPwd" ShowRedStar="true" Width="250px"></f:TextBox>
                            <f:TextBox runat="server" Label="确认新密码" ID="txtPwd1" ShowRedStar="true" Width="250px"></f:TextBox>
