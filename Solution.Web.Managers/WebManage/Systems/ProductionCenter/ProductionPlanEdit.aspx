<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductionPlanEdit.aspx.cs" Inherits="Solution.Web.Managers.WebManage.Systems.ProductionCenter.ProductionPlanEdit" %>
                ...
                <Items>
                    <f:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false"
                        ...
                        <Items>
                            ...
                            <f:TextBox runat="server" ID="txtPLAN_ID" ShowRedStar="true" Width="250px" Label="计划单号" />
                            ...
                            <f:TextBox runat="server" ID="txtEXPECT_DATE" ShowRedStar="true" Width="250px" Label="期望日期" />
                            <f:TextBox runat="server" ID="txtPREPARE_ID" ShowRedStar="true" Width="250px" Label="备料单号" />
                            <f:TextBox runat="server" ID="txtEXPORTED" ShowRedStar="true" Width="250px" Label="引入标记" />
                            <f:TextBox runat="server" ID="txtEXPORTED_ID" ShowRedStar="true" Width="250px" Label="引入单号" />
                            <f:TextBox runat="server" ID="txtDIV_ID" ShowRedStar="true" Width="250px" Label="生产部门" />
