...
namespace DotNet.Utilities
{
    ...
    public class DataTableHelper
    {
        ...
        /// <param name="parentId">父ID值，用于查询分类列表时，只显示指定一级分类下面的全部分类</param>
        /// <returns></returns>
        public static DataTable DataTableTidyUp2(DataTable dtable, string pkFiled, string parentIdFiled, int parentId, string PagePower)
        {
            ...
            foreach (DataRow item in dtable.Rows)
            {
                ...
                if (PagePower !="" && PagePower.IndexOf("|" + item[pkFiled].ToString() + "|") < 0)
                {
                    continue;
                }
        ...
        /// <param name="parentId">父ID值，用于查询分类列表时，只显示指定一级分类下面的全部分类</param>
        /// <returns></returns>
        public static DataTable DataTableTidyUp1(DataTable dtable, string pkFiled, string parentIdFiled, int parentId, string PagePower)
        {
        ...
        /// <param name="parentId">父ID值，用于查询分类列表时，只显示指定一级分类下面的全部分类</param>
        /// <returns></returns>
        public static DataTable DataTableTidyUp4(DataTable dtable, string pkFiled, string parentIdFiled, int menuInfoId)
        {
