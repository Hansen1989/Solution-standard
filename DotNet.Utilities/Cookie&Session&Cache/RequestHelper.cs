...
namespace DotNet.Utilities
{
    public class RequestHelper
    {
        ...
        public static string GetFormString(string strName, bool isFilterXss = true)
        {
            ...
            return StringHelper.FilterSql(HttpContext.Current.Request.Form[strName], true, true);
        }
        ...
        public static string GetQueryString(string strName, bool isFilterXss = true)
        {
            ...
            return StringHelper.FilterSql(HttpContext.Current.Request.QueryString[strName], true, true);
        }
