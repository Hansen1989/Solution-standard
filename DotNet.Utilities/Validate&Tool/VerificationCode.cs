...
namespace DotNet.Utilities
{
    ...
    public class VerificationCode
    {
        ...
        private static string tempstring = "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz";
        ...
        /// </summary>
        private static int _CountCode = 4;
        ...
        /// <summary>生成验证码码图片的宽度
        /// </summary>
        private static int _ImageWidth = 200;
        /// <summary>生成验证码图片的宽度
        /// </summary>
        ...
        /// <summary>生成验证码图片的高度
        /// </summary>
        private static int _ImageHeight = 30;
        /// <summary>生成验证码图片的高度
        /// 
        /// </summary>
        ...
        /// <summary>设定图片的噪点线数量
        /// </summary>
        private static int _NoiseLine = 0;
        /// <summary>设定图片的噪点线数量
        /// </summary>
        public static int NoiseLine
        {
        ...
        /// <summary> 前景干扰点
        /// </summary>
        private static int _NoisePoint = 0;

        /// <summary>设定验证码图片的前景干扰点数量
        /// </summary>
        public static int NoisePoint
        {
        ...
        {
            internal get { return VerificationCode._FontSize; }
            set { VerificationCode._FontSize = value; }
        }
