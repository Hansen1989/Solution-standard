...
namespace Solution.Logic.Managers
{
    ...
    public partial class MenuInfoBll : LogicBase
    {
        ...
        public void BandDropDownListShowMenu(Page page, FineUI.DropDownList ddl)
        {
            ...
            //在内存中筛选记录
            var dt = DataTableHelper.GetFilterData(GetDataTable(), string.Format("{0}={1} or {2} = {3}", MenuInfoTable.IsMenu,1,MenuInfoTable.IsMenu,0), MenuInfoTable.Depth + ", " + MenuInfoTable.Sort);
        ...
        /// 绑定菜单下拉列表——只显示所有可以显示的菜单（IsMenu)
        /// </summary>
        public void BandDropDownListShowMenu2(Page page, FineUI.Grid grid2,string PagePower, string ControlPower)
        {
            ...
            try
            {
                ...
                //整理出有层次感的数据
                var dt2 = DataTableHelper.DataTableTidyUp2(dt, MenuInfoTable.Id, MenuInfoTable.ParentId, 0,PagePower);
        ...
        /// 绑定菜单下拉列表——只显示所有可以显示的菜单（IsMenu)
        /// </summary>
        public void BandDropDownListShowMenu3(Page page, FineUI.Grid grid3,string PagePower, string ControlPower)
        {
            ...
            try
            {
                ...
                //整理出有层次感的数据
                var dt3 = DataTableHelper.DataTableTidyUp2(dt, MenuInfoTable.Id, MenuInfoTable.ParentId, 0,PagePower);
        ...
        /// 绑定菜单下拉列表——只显示所有可以显示的菜单（IsMenu)
        /// </summary>
        public void BandDropDownListShowMenu1(Page page, FineUI.Grid grid, string _PagePower, string ControlPower)
        {

            //在内存中筛选记录

            var dt1 = DataTableHelper.GetFilterData(GetDataTable(), string.Format("{0}={1} or {2} = {3}", MenuInfoTable.IsMenu, 1, MenuInfoTable.IsMenu, 0), MenuInfoTable.Depth + ", " + MenuInfoTable.Sort);
            //var dt2 = DataTableHelper.GetFilterData(GetDataTable(), string.Format("{0} in {1}", MenuInfoTable.Id, _PagePower), MenuInfoTable.Depth + ", " + MenuInfoTable.Sort);
            ...
            try
            {
                ...
                // dt_2 = DataTableHelper.DataTableTidyUp(dt2, MenuInfoTable.Id, MenuInfoTable.ParentId, 0);

                grid.DataSource = DataTableHelper.DataTableTidyUp1(dt1, MenuInfoTable.Id, MenuInfoTable.ParentId, 0, _PagePower);
                grid.DataBind();

                //grid2.DataSource = dt_2;
                //grid2.DataBind();
        ...
        /// 绑定菜单下拉列表——只显示一级菜单
        /// </summary>
        public void BandMenuInfoList1(Page page, FineUI.Grid grid)
        {
            //在内存中筛选记录
            ...
            try
            {
                ...
                grid.DataSource = DataTableHelper.DataTableTidyUp(dt1, MenuInfoTable.Id, MenuInfoTable.ParentId, 0);
                grid.DataBind();
