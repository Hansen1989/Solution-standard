	...
	public partial class SYS_PARAMATERSBll : LogicBase {
        ...
        {			
            ...
            return new DataAccess.Model.SYS_PARAMATERS
            {
                ...
                COL_ORDER_TYPE = model.COL_ORDER_TYPE,
                ORDER_PRICE_TYPE = model.ORDER_PRICE_TYPE,
                QUANTITY_TYPE = model.QUANTITY_TYPE,
                EXPECT_DATE_TYPE = model.EXPECT_DATE_TYPE,
                PRD_BOM_TYPE = model.PRD_BOM_TYPE,
		...
		public void SetModelValue(DataAccess.Model.SYS_PARAMATERS model, string colName, object value)
		{
            ...
            switch (colName)
            {
				...
				case "AREA_ID" :
                    ...
                    break;
				case "COL_ORDER_TYPE" :
					model.COL_ORDER_TYPE = (int)value;
                    break;
				case "ORDER_PRICE_TYPE" :
					model.ORDER_PRICE_TYPE = (int)value;
                    break;
				case "QUANTITY_TYPE" :
					model.QUANTITY_TYPE = (int)value;
                    break;
				case "EXPECT_DATE_TYPE" :
					model.EXPECT_DATE_TYPE = (int)value;
                    break;
				case "PRD_BOM_TYPE" :
					model.PRD_BOM_TYPE = (int)value;
                    break;
				case "CRT_DATETIME" :
		...
		private object GetFieldValue(DataAccess.Model.SYS_PARAMATERS model, string colName)
		{
			...
			switch (colName)
			{
				...
				case "COL_ORDER_TYPE" :
					return model.COL_ORDER_TYPE;
				case "ORDER_PRICE_TYPE" :
					return model.ORDER_PRICE_TYPE;
				case "QUANTITY_TYPE" :
					return model.QUANTITY_TYPE;
				case "EXPECT_DATE_TYPE" :
					return model.EXPECT_DATE_TYPE;
				case "PRD_BOM_TYPE" :
					return model.PRD_BOM_TYPE;
				case "CRT_DATETIME" :
