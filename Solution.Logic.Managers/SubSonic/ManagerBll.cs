	...
	public partial class ManagerBll : LogicBase {
	    ...
	    public void UpdateValue(Page page, int id, Dictionary<string, object> dic, string content = "", bool isCache = true, bool isAddUseLog = true)
        {
            ...
            if (id > 0)
            {
                ...
                wheres.Add(new ConditionFun.SqlqueryCondition(ConstraintType.And, ManagerTable.Id, Comparison.Equals, id));
            };
	    ...
	    public void UpdateValue_For_Branch_Id(Page page, int Branch_Id, Dictionary<string, object> dic, string content = "", bool isCache = true, bool isAddUseLog = true)
        {
            ...
            var wheres = new List<ConditionFun.SqlqueryCondition>
            {
                new ConditionFun.SqlqueryCondition(ConstraintType.And, ManagerTable.Branch_Id, Comparison.Equals, Branch_Id)
            };
		...
		public void DelPhotoImg(Page page, int pkValue, bool isCache = true) {
			try {
				...
				//设置条件
				var wheres = new List<ConditionFun.SqlqueryCondition>();
				wheres.Add(new ConditionFun.SqlqueryCondition(ConstraintType.And, ManagerTable.Id, Comparison.Equals, pkValue));
