...
{    
    /// <summary>
    /// A class which represents the Col_Order00 table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class Col_Order00: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Col_Order00>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
