...
namespace Solution.DataAccess.DataModel {
        ...
        public class PREPARE00Structs: DatabaseTable {
            
            public PREPARE00Structs(IDataProvider provider):base("PREPARE00",provider){
                ClassName = "PREPARE00";
                SchemaName = "dbo";
                ...
                Columns.Add(new DatabaseColumn("PREPAR_ID", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = false,
                ...
                Columns.Add(new DatabaseColumn("PRE_TYPE", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.Int32,
	                IsNullable = false,
            ...
            public IColumn PREPAR_ID{
                get{
                    return this.GetColumn("PREPAR_ID");
                }
            }
            ...
            public IColumn PRE_TYPE{
                get{
                    return this.GetColumn("PRE_TYPE");
                }
            }
