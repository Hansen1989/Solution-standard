...
{    
    /// <summary>
    /// A class which represents the PROD_DEP table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class PROD_DEP: IActiveRecord
    {
    
        #region Built-in testing
        static TestRepository<PROD_DEP> _testRepo;
        

        
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<PROD_DEP>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        }
        public static void Setup(List<PROD_DEP> testlist){
            SetTestRepo();
        ...
        public PROD_DEP(string connectionString, string providerName) {
        ...
        public PROD_DEP(Expression<Func<PROD_DEP, bool>> expression):this() {
        ...
        internal static IRepository<PROD_DEP> GetRepo(){
            return GetRepo("","");
        }
        ...
        public static bool Exists(Expression<Func<PROD_DEP, bool>> expression,string connectionString, string providerName) {
           
            return All(connectionString,providerName).Any(expression);
        }        
        public static bool Exists(Expression<Func<PROD_DEP, bool>> expression) {
           
            return All().Any(expression);
        }        

        public static IList<PROD_DEP> Find(Expression<Func<PROD_DEP, bool>> expression) {
            
            var repo = GetRepo();
            return repo.Find(expression).ToList();
        }
        
        public static IList<PROD_DEP> Find(Expression<Func<PROD_DEP, bool>> expression,string connectionString, string providerName) {

            var repo = GetRepo(connectionString,providerName);
            return repo.Find(expression).ToList();

        }
        public static IQueryable<PROD_DEP> All(string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetAll();
        }
        public static IQueryable<PROD_DEP> All() {
            return GetRepo().GetAll();
        }
        
        public static PagedList<PROD_DEP> GetPaged(string sortBy, int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(sortBy, pageIndex, pageSize);
        }
      
        public static PagedList<PROD_DEP> GetPaged(string sortBy, int pageIndex, int pageSize) {
            return GetRepo().GetPaged(sortBy, pageIndex, pageSize);
        }

        public static PagedList<PROD_DEP> GetPaged(int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(pageIndex, pageSize);
            
        }


        public static PagedList<PROD_DEP> GetPaged(int pageIndex, int pageSize) {
        ...
        public static void Delete(Expression<Func<PROD_DEP, bool>> expression) {
            var repo = GetRepo();
