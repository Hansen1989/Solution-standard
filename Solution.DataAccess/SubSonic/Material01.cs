...
{    
    /// <summary>
    /// A class which represents the Material01 table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class Material01: IActiveRecord
    {
    
        #region Built-in testing
        static TestRepository<Material01> _testRepo;
        

        
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Material01>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        }
        public static void Setup(List<Material01> testlist){
            SetTestRepo();
        ...
        public static void Setup(Material01 item) {
            SetTestRepo();
            _testRepo._items.Add(item);
        }
        public static void Setup(int testItems) {
            ...
            for(int i=0;i<testItems;i++){
                Material01 item=new Material01();
                _testRepo._items.Add(item);
            }
        }
        ...
        public Material01(string connectionString, string providerName) {
        ...
        void Init(){
            ...
            if(TestMode){
                Material01.SetTestRepo();
                _repo=_testRepo;
            }else{
                _repo = new SubSonicRepository<Material01>(_db);
            }
            tbl=_repo.GetTable();
            SetIsNew(true);
            OnCreated();       
        ...
        public Material01(Expression<Func<Material01, bool>> expression):this() {
        ...
        internal static IRepository<Material01> GetRepo(string connectionString, string providerName){
            ...
            if(db.TestMode){
                ...
                _repo = new SubSonicRepository<Material01>(db);
            }
            return _repo;        
        }       
        
        internal static IRepository<Material01> GetRepo(){
            return GetRepo("","");
        }
        
        public static Material01 SingleOrDefault(Expression<Func<Material01, bool>> expression) {

            var repo = GetRepo();
            var results=repo.Find(expression);
            Material01 single=null;
            if(results.Count() > 0){
        ...
        public static Material01 SingleOrDefault(Expression<Func<Material01, bool>> expression,string connectionString, string providerName) {
        ...
        public static bool Exists(Expression<Func<Material01, bool>> expression,string connectionString, string providerName) {
           
            return All(connectionString,providerName).Any(expression);
        }        
        public static bool Exists(Expression<Func<Material01, bool>> expression) {
           
            return All().Any(expression);
        }        

        public static IList<Material01> Find(Expression<Func<Material01, bool>> expression) {
            
            var repo = GetRepo();
            return repo.Find(expression).ToList();
        }
        
        public static IList<Material01> Find(Expression<Func<Material01, bool>> expression,string connectionString, string providerName) {

            var repo = GetRepo(connectionString,providerName);
            return repo.Find(expression).ToList();

        }
        public static IQueryable<Material01> All(string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetAll();
        }
        public static IQueryable<Material01> All() {
            return GetRepo().GetAll();
        }
        
        public static PagedList<Material01> GetPaged(string sortBy, int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(sortBy, pageIndex, pageSize);
        }
      
        public static PagedList<Material01> GetPaged(string sortBy, int pageIndex, int pageSize) {
            return GetRepo().GetPaged(sortBy, pageIndex, pageSize);
        }

        public static PagedList<Material01> GetPaged(int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(pageIndex, pageSize);
            
        }


        public static PagedList<Material01> GetPaged(int pageIndex, int pageSize) {
        ...
        public override bool Equals(object obj){
            if(obj.GetType()==typeof(Material01)){
                Material01 compare=(Material01)obj;
        ...
        public static void Delete(Expression<Func<Material01, bool>> expression) {
            var repo = GetRepo();
