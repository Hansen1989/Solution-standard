...
{    
    /// <summary>
    /// A class which represents the COMPONENT01 table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class COMPONENT01: IActiveRecord
    {
    
        #region Built-in testing
        static TestRepository<COMPONENT01> _testRepo;
        

        
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<COMPONENT01>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        }
        public static void Setup(List<COMPONENT01> testlist){
            SetTestRepo();
        ...
        public static void Setup(COMPONENT01 item) {
            SetTestRepo();
            _testRepo._items.Add(item);
        }
        public static void Setup(int testItems) {
            ...
            for(int i=0;i<testItems;i++){
                COMPONENT01 item=new COMPONENT01();
                _testRepo._items.Add(item);
            }
        }
        ...
        public COMPONENT01(string connectionString, string providerName) {
        ...
        void Init(){
            ...
            if(TestMode){
                COMPONENT01.SetTestRepo();
                _repo=_testRepo;
            }else{
                _repo = new SubSonicRepository<COMPONENT01>(_db);
            }
            tbl=_repo.GetTable();
            SetIsNew(true);
            OnCreated();       
        ...
        public COMPONENT01(Expression<Func<COMPONENT01, bool>> expression):this() {
        ...
        internal static IRepository<COMPONENT01> GetRepo(string connectionString, string providerName){
            ...
            if(db.TestMode){
                ...
                _repo = new SubSonicRepository<COMPONENT01>(db);
            }
            return _repo;        
        }       
        
        internal static IRepository<COMPONENT01> GetRepo(){
            return GetRepo("","");
        }
        
        public static COMPONENT01 SingleOrDefault(Expression<Func<COMPONENT01, bool>> expression) {

            var repo = GetRepo();
            var results=repo.Find(expression);
            COMPONENT01 single=null;
            if(results.Count() > 0){
        ...
        public static COMPONENT01 SingleOrDefault(Expression<Func<COMPONENT01, bool>> expression,string connectionString, string providerName) {
        ...
        public static bool Exists(Expression<Func<COMPONENT01, bool>> expression,string connectionString, string providerName) {
           
            return All(connectionString,providerName).Any(expression);
        }        
        public static bool Exists(Expression<Func<COMPONENT01, bool>> expression) {
           
            return All().Any(expression);
        }        

        public static IList<COMPONENT01> Find(Expression<Func<COMPONENT01, bool>> expression) {
            
            var repo = GetRepo();
            return repo.Find(expression).ToList();
        }
        
        public static IList<COMPONENT01> Find(Expression<Func<COMPONENT01, bool>> expression,string connectionString, string providerName) {

            var repo = GetRepo(connectionString,providerName);
            return repo.Find(expression).ToList();

        }
        public static IQueryable<COMPONENT01> All(string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetAll();
        }
        public static IQueryable<COMPONENT01> All() {
            return GetRepo().GetAll();
        }
        
        public static PagedList<COMPONENT01> GetPaged(string sortBy, int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(sortBy, pageIndex, pageSize);
        }
      
        public static PagedList<COMPONENT01> GetPaged(string sortBy, int pageIndex, int pageSize) {
            return GetRepo().GetPaged(sortBy, pageIndex, pageSize);
        }

        public static PagedList<COMPONENT01> GetPaged(int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(pageIndex, pageSize);
            
        }


        public static PagedList<COMPONENT01> GetPaged(int pageIndex, int pageSize) {
        ...
        public override bool Equals(object obj){
            if(obj.GetType()==typeof(COMPONENT01)){
                COMPONENT01 compare=(COMPONENT01)obj;
        ...
        public static void Delete(Expression<Func<COMPONENT01, bool>> expression) {
            var repo = GetRepo();
