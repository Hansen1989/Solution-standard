...
{    
    /// <summary>
    /// A class which represents the UploadType table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class UploadType: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<UploadType>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
