...
namespace Solution.DataAccess.DataModel {
        ...
        public class ORDER_DEP00Structs: DatabaseTable {
            
            public ORDER_DEP00Structs(IDataProvider provider):base("ORDER_DEP00",provider){
                ClassName = "ORDER_DEP00";
                SchemaName = "dbo";
                ...
                Columns.Add(new DatabaseColumn("ORDDEP_NAME", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = false,
	                ...
	                IsForeignKey = false,
	                MaxLength = 20,
					PropertyName = "ORDDEP_NAME"
                });

                Columns.Add(new DatabaseColumn("ORDER_WEEK", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = true,
            ...
            public IColumn ORDDEP_NAME{
                get{
                    return this.GetColumn("ORDDEP_NAME");
                }
            }
				
            
            public IColumn ORDER_WEEK{
                get{
                    return this.GetColumn("ORDER_WEEK");
                }
            }
