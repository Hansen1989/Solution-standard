...
{    
    /// <summary>
    /// A class which represents the MenuInfo table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class MenuInfo: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<MenuInfo>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
