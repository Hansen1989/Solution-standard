...
namespace Solution.DataAccess.DataModel {
        ...
        public class V_STOCK_SHOP00Structs: DatabaseTable {
            
            public V_STOCK_SHOP00Structs(IDataProvider provider):base("V_STOCK_SHOP00",provider){
                ClassName = "V_STOCK_SHOP00";
                SchemaName = "dbo";
                ...
                Columns.Add(new DatabaseColumn("Stock_Kind_Name", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = false,
            ...
            public IColumn Stock_Kind_Name{
                get{
                    return this.GetColumn("Stock_Kind_Name");
                }
            }
