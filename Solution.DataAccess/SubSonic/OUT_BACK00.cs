...
{    
    /// <summary>
    /// A class which represents the OUT_BACK00 table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class OUT_BACK00: IActiveRecord
    {
    
        #region Built-in testing
        static TestRepository<OUT_BACK00> _testRepo;
        

        
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<OUT_BACK00>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        }
        public static void Setup(List<OUT_BACK00> testlist){
            SetTestRepo();
        ...
        public static void Setup(OUT_BACK00 item) {
            SetTestRepo();
            _testRepo._items.Add(item);
        }
        public static void Setup(int testItems) {
            ...
            for(int i=0;i<testItems;i++){
                OUT_BACK00 item=new OUT_BACK00();
                _testRepo._items.Add(item);
            }
        }
        ...
        public OUT_BACK00(string connectionString, string providerName) {
        ...
        void Init(){
            ...
            if(TestMode){
                OUT_BACK00.SetTestRepo();
                _repo=_testRepo;
            }else{
                _repo = new SubSonicRepository<OUT_BACK00>(_db);
            }
            tbl=_repo.GetTable();
            SetIsNew(true);
            OnCreated();       
        ...
        public OUT_BACK00(Expression<Func<OUT_BACK00, bool>> expression):this() {
        ...
        internal static IRepository<OUT_BACK00> GetRepo(string connectionString, string providerName){
            ...
            if(db.TestMode){
                ...
                _repo = new SubSonicRepository<OUT_BACK00>(db);
            }
            return _repo;        
        }       
        
        internal static IRepository<OUT_BACK00> GetRepo(){
            return GetRepo("","");
        }
        
        public static OUT_BACK00 SingleOrDefault(Expression<Func<OUT_BACK00, bool>> expression) {

            var repo = GetRepo();
            var results=repo.Find(expression);
            OUT_BACK00 single=null;
            if(results.Count() > 0){
        ...
        public static OUT_BACK00 SingleOrDefault(Expression<Func<OUT_BACK00, bool>> expression,string connectionString, string providerName) {
        ...
        public static bool Exists(Expression<Func<OUT_BACK00, bool>> expression,string connectionString, string providerName) {
           
            return All(connectionString,providerName).Any(expression);
        }        
        public static bool Exists(Expression<Func<OUT_BACK00, bool>> expression) {
           
            return All().Any(expression);
        }        

        public static IList<OUT_BACK00> Find(Expression<Func<OUT_BACK00, bool>> expression) {
            
            var repo = GetRepo();
            return repo.Find(expression).ToList();
        }
        
        public static IList<OUT_BACK00> Find(Expression<Func<OUT_BACK00, bool>> expression,string connectionString, string providerName) {

            var repo = GetRepo(connectionString,providerName);
            return repo.Find(expression).ToList();

        }
        public static IQueryable<OUT_BACK00> All(string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetAll();
        }
        public static IQueryable<OUT_BACK00> All() {
            return GetRepo().GetAll();
        }
        
        public static PagedList<OUT_BACK00> GetPaged(string sortBy, int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(sortBy, pageIndex, pageSize);
        }
      
        public static PagedList<OUT_BACK00> GetPaged(string sortBy, int pageIndex, int pageSize) {
            return GetRepo().GetPaged(sortBy, pageIndex, pageSize);
        }

        public static PagedList<OUT_BACK00> GetPaged(int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(pageIndex, pageSize);
            
        }


        public static PagedList<OUT_BACK00> GetPaged(int pageIndex, int pageSize) {
        ...
        public override bool Equals(object obj){
            if(obj.GetType()==typeof(OUT_BACK00)){
                OUT_BACK00 compare=(OUT_BACK00)obj;
        ...
        public static void Delete(Expression<Func<OUT_BACK00, bool>> expression) {
            var repo = GetRepo();
