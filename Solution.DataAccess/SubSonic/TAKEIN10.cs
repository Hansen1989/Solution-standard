...
{    
    /// <summary>
    /// A class which represents the TAKEIN10 table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class TAKEIN10: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<TAKEIN10>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
