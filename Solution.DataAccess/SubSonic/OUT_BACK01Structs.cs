...
namespace Solution.DataAccess.DataModel {
        ...
        public class OUT_BACK01Structs: DatabaseTable {
            
            public OUT_BACK01Structs(IDataProvider provider):base("OUT_BACK01",provider){
                ClassName = "OUT_BACK01";
                SchemaName = "dbo";
                ...
                Columns.Add(new DatabaseColumn("BK_ID", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = false,
                ...
                Columns.Add(new DatabaseColumn("REASON_ID", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = true,
            ...
            public IColumn BK_ID{
                get{
                    return this.GetColumn("BK_ID");
                }
            }
            ...
            public IColumn REASON_ID{
                get{
                    return this.GetColumn("REASON_ID");
                }
            }
