...
{    
    /// <summary>
    /// A class which represents the V_STOCK01_PRODUCT00 table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class V_STOCK01_PRODUCT00: IActiveRecord
    {
    
        #region Built-in testing
        static TestRepository<V_STOCK01_PRODUCT00> _testRepo;
        

        
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<V_STOCK01_PRODUCT00>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        }
        public static void Setup(List<V_STOCK01_PRODUCT00> testlist){
            SetTestRepo();
        ...
        public static void Setup(V_STOCK01_PRODUCT00 item) {
            SetTestRepo();
            _testRepo._items.Add(item);
        }
        public static void Setup(int testItems) {
            ...
            for(int i=0;i<testItems;i++){
                V_STOCK01_PRODUCT00 item=new V_STOCK01_PRODUCT00();
                _testRepo._items.Add(item);
            }
        }
        ...
        IRepository<V_STOCK01_PRODUCT00> _repo;
        ITable tbl;
        bool _isNew;
        public bool IsNew(){
            return _isNew;
        ...
        public V_STOCK01_PRODUCT00(string connectionString, string providerName) {
        ...
        void Init(){
            ...
            if(TestMode){
                V_STOCK01_PRODUCT00.SetTestRepo();
                _repo=_testRepo;
            }else{
                _repo = new SubSonicRepository<V_STOCK01_PRODUCT00>(_db);
            }
            tbl=_repo.GetTable();
            SetIsNew(true);
            OnCreated();       
        ...
        public V_STOCK01_PRODUCT00(Expression<Func<V_STOCK01_PRODUCT00, bool>> expression):this() {
        ...
        internal static IRepository<V_STOCK01_PRODUCT00> GetRepo(string connectionString, string providerName){
            ...
            if(db.TestMode){
                ...
                _repo = new SubSonicRepository<V_STOCK01_PRODUCT00>(db);
            }
            return _repo;        
        }       
        
        internal static IRepository<V_STOCK01_PRODUCT00> GetRepo(){
            return GetRepo("","");
        }
        
        public static V_STOCK01_PRODUCT00 SingleOrDefault(Expression<Func<V_STOCK01_PRODUCT00, bool>> expression) {

            var repo = GetRepo();
            var results=repo.Find(expression);
            V_STOCK01_PRODUCT00 single=null;
            if(results.Count() > 0){
        ...
        public static V_STOCK01_PRODUCT00 SingleOrDefault(Expression<Func<V_STOCK01_PRODUCT00, bool>> expression,string connectionString, string providerName) {
        ...
        public static bool Exists(Expression<Func<V_STOCK01_PRODUCT00, bool>> expression,string connectionString, string providerName) {
           
            return All(connectionString,providerName).Any(expression);
        }        
        public static bool Exists(Expression<Func<V_STOCK01_PRODUCT00, bool>> expression) {
           
            return All().Any(expression);
        }        

        public static IList<V_STOCK01_PRODUCT00> Find(Expression<Func<V_STOCK01_PRODUCT00, bool>> expression) {
            
            var repo = GetRepo();
            return repo.Find(expression).ToList();
        }
        
        public static IList<V_STOCK01_PRODUCT00> Find(Expression<Func<V_STOCK01_PRODUCT00, bool>> expression,string connectionString, string providerName) {

            var repo = GetRepo(connectionString,providerName);
            return repo.Find(expression).ToList();

        }
        public static IQueryable<V_STOCK01_PRODUCT00> All(string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetAll();
        }
        public static IQueryable<V_STOCK01_PRODUCT00> All() {
            return GetRepo().GetAll();
        }
        
        public static PagedList<V_STOCK01_PRODUCT00> GetPaged(string sortBy, int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(sortBy, pageIndex, pageSize);
        }
      
        public static PagedList<V_STOCK01_PRODUCT00> GetPaged(string sortBy, int pageIndex, int pageSize) {
            return GetRepo().GetPaged(sortBy, pageIndex, pageSize);
        }

        public static PagedList<V_STOCK01_PRODUCT00> GetPaged(int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(pageIndex, pageSize);
            
        }


        public static PagedList<V_STOCK01_PRODUCT00> GetPaged(int pageIndex, int pageSize) {
        ...
        public override bool Equals(object obj){
            if(obj.GetType()==typeof(V_STOCK01_PRODUCT00)){
                V_STOCK01_PRODUCT00 compare=(V_STOCK01_PRODUCT00)obj;
        ...
        public static void Delete(Expression<Func<V_STOCK01_PRODUCT00, bool>> expression) {
            var repo = GetRepo();
