...
{    
    /// <summary>
    /// A class which represents the Position table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class Position: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Position>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
