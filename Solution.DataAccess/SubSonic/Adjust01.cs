...
{    
    /// <summary>
    /// A class which represents the Adjust01 table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class Adjust01: IActiveRecord
    {
    
        #region Built-in testing
        static TestRepository<Adjust01> _testRepo;
        

        
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Adjust01>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        }
        public static void Setup(List<Adjust01> testlist){
            SetTestRepo();
        ...
        public static void Setup(Adjust01 item) {
            SetTestRepo();
            _testRepo._items.Add(item);
        }
        ...
        public Adjust01(string connectionString, string providerName) {
        ...
        void Init(){
            ...
            if(TestMode){
                Adjust01.SetTestRepo();
                _repo=_testRepo;
            }else{
                _repo = new SubSonicRepository<Adjust01>(_db);
            }
            tbl=_repo.GetTable();
            SetIsNew(true);
            OnCreated();       
        ...
        public Adjust01(Expression<Func<Adjust01, bool>> expression):this() {
        ...
        internal static IRepository<Adjust01> GetRepo(string connectionString, string providerName){
            ...
            if(db.TestMode){
                ...
                _repo = new SubSonicRepository<Adjust01>(db);
            }
            return _repo;        
        }       
        
        internal static IRepository<Adjust01> GetRepo(){
            return GetRepo("","");
        }
        
        public static Adjust01 SingleOrDefault(Expression<Func<Adjust01, bool>> expression) {

            var repo = GetRepo();
            var results=repo.Find(expression);
            Adjust01 single=null;
            if(results.Count() > 0){
        ...
        public static Adjust01 SingleOrDefault(Expression<Func<Adjust01, bool>> expression,string connectionString, string providerName) {
        ...
        public static bool Exists(Expression<Func<Adjust01, bool>> expression,string connectionString, string providerName) {
           
            return All(connectionString,providerName).Any(expression);
        }        
        public static bool Exists(Expression<Func<Adjust01, bool>> expression) {
           
            return All().Any(expression);
        }        

        public static IList<Adjust01> Find(Expression<Func<Adjust01, bool>> expression) {
            
            var repo = GetRepo();
            return repo.Find(expression).ToList();
        }
        
        public static IList<Adjust01> Find(Expression<Func<Adjust01, bool>> expression,string connectionString, string providerName) {

            var repo = GetRepo(connectionString,providerName);
            return repo.Find(expression).ToList();

        }
        public static IQueryable<Adjust01> All(string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetAll();
        }
        public static IQueryable<Adjust01> All() {
            return GetRepo().GetAll();
        }
        
        public static PagedList<Adjust01> GetPaged(string sortBy, int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(sortBy, pageIndex, pageSize);
        }
      
        public static PagedList<Adjust01> GetPaged(string sortBy, int pageIndex, int pageSize) {
            return GetRepo().GetPaged(sortBy, pageIndex, pageSize);
        }

        public static PagedList<Adjust01> GetPaged(int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(pageIndex, pageSize);
            
        }


        public static PagedList<Adjust01> GetPaged(int pageIndex, int pageSize) {
        ...
        public override bool Equals(object obj){
            if(obj.GetType()==typeof(Adjust01)){
                Adjust01 compare=(Adjust01)obj;
        ...
        public static void Delete(Expression<Func<Adjust01, bool>> expression) {
            var repo = GetRepo();
