...
{    
    /// <summary>
    /// A class which represents the UploadFile table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class UploadFile: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<UploadFile>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
