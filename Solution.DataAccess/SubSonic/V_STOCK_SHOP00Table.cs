...
namespace Solution.DataAccess.DataModel {
        /// <summary>
        /// Table: V_STOCK_SHOP00
        /// </summary>

        public class V_STOCK_SHOP00Table {
			/// <summary>
			/// 表名
			/// </summary>
			public static string TableName {
				get{
        			return "V_STOCK_SHOP00";
      			}
			}
			...
			/// 
			/// </summary>
   			public static string IsDefBill{
			      get{
        			return "IsDefBill";
      			}
		    }
			...
			/// 
			/// </summary>
   			public static string Stock_Kind{
			      get{
        			return "Stock_Kind";
      			}
		    }
			...
			/// 
			/// </summary>
   			public static string Stock_Kind_Name{
			      get{
        			return "Stock_Kind_Name";
      			}
		    }
