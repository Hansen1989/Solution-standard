...
{    
    /// <summary>
    /// A class which represents the Manager table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class Manager: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Manager>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
