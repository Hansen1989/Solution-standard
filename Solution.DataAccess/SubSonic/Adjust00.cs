...
{    
    /// <summary>
    /// A class which represents the Adjust00 table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class Adjust00: IActiveRecord
    {
    
        #region Built-in testing
        static TestRepository<Adjust00> _testRepo;
        

        
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Adjust00>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        }
        public static void Setup(List<Adjust00> testlist){
            SetTestRepo();
        ...
        public static void Setup(Adjust00 item) {
            SetTestRepo();
            _testRepo._items.Add(item);
        }
        ...
        public Adjust00(string connectionString, string providerName) {
        ...
        void Init(){
            ...
            if(TestMode){
                Adjust00.SetTestRepo();
                _repo=_testRepo;
            }else{
                _repo = new SubSonicRepository<Adjust00>(_db);
            }
            tbl=_repo.GetTable();
            SetIsNew(true);
            OnCreated();       
        ...
        public Adjust00(Expression<Func<Adjust00, bool>> expression):this() {
        ...
        internal static IRepository<Adjust00> GetRepo(string connectionString, string providerName){
            ...
            if(db.TestMode){
                ...
                _repo = new SubSonicRepository<Adjust00>(db);
            }
            return _repo;        
        }       
        
        internal static IRepository<Adjust00> GetRepo(){
            return GetRepo("","");
        }
        
        public static Adjust00 SingleOrDefault(Expression<Func<Adjust00, bool>> expression) {

            var repo = GetRepo();
            var results=repo.Find(expression);
            Adjust00 single=null;
            if(results.Count() > 0){
        ...
        public static Adjust00 SingleOrDefault(Expression<Func<Adjust00, bool>> expression,string connectionString, string providerName) {
        ...
        public static bool Exists(Expression<Func<Adjust00, bool>> expression,string connectionString, string providerName) {
           
            return All(connectionString,providerName).Any(expression);
        }        
        public static bool Exists(Expression<Func<Adjust00, bool>> expression) {
           
            return All().Any(expression);
        }        

        public static IList<Adjust00> Find(Expression<Func<Adjust00, bool>> expression) {
            
            var repo = GetRepo();
            return repo.Find(expression).ToList();
        }
        
        public static IList<Adjust00> Find(Expression<Func<Adjust00, bool>> expression,string connectionString, string providerName) {

            var repo = GetRepo(connectionString,providerName);
            return repo.Find(expression).ToList();

        }
        public static IQueryable<Adjust00> All(string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetAll();
        }
        public static IQueryable<Adjust00> All() {
            return GetRepo().GetAll();
        }
        
        public static PagedList<Adjust00> GetPaged(string sortBy, int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(sortBy, pageIndex, pageSize);
        }
      
        public static PagedList<Adjust00> GetPaged(string sortBy, int pageIndex, int pageSize) {
            return GetRepo().GetPaged(sortBy, pageIndex, pageSize);
        }

        public static PagedList<Adjust00> GetPaged(int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(pageIndex, pageSize);
            
        }


        public static PagedList<Adjust00> GetPaged(int pageIndex, int pageSize) {
        ...
        public override bool Equals(object obj){
            if(obj.GetType()==typeof(Adjust00)){
                Adjust00 compare=(Adjust00)obj;
        ...
        public string AD_ID
        {
            ...
            set
            {
                if(_AD_ID!=value || _isLoaded){
                    _AD_ID=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="AD_ID");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
        ...
        public int ADJUST_TYPE
        {
            ...
            set
            {
                if(_ADJUST_TYPE!=value || _isLoaded){
                    _ADJUST_TYPE=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="ADJUST_TYPE");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
        ...
        public static void Delete(Expression<Func<Adjust00, bool>> expression) {
            var repo = GetRepo();
