...
{    
    /// <summary>
    /// A class which represents the Dispose00 table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class Dispose00: IActiveRecord
    {
    
        #region Built-in testing
        static TestRepository<Dispose00> _testRepo;
        

        
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Dispose00>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        }
        public static void Setup(List<Dispose00> testlist){
            SetTestRepo();
        ...
        public static void Setup(Dispose00 item) {
            SetTestRepo();
            _testRepo._items.Add(item);
        }
        ...
        public Dispose00(string connectionString, string providerName) {
        ...
        void Init(){
            ...
            if(TestMode){
                Dispose00.SetTestRepo();
                _repo=_testRepo;
            }else{
                _repo = new SubSonicRepository<Dispose00>(_db);
            }
            tbl=_repo.GetTable();
            SetIsNew(true);
            OnCreated();       
		...
		public void ORMapping(IDataRecord dataRecord)
        {
            ...
            DP_TYPE = readRecord.get_int("DP_TYPE",null);
        ...
        public Dispose00(Expression<Func<Dispose00, bool>> expression):this() {
        ...
        internal static IRepository<Dispose00> GetRepo(string connectionString, string providerName){
            ...
            if(db.TestMode){
                ...
                _repo = new SubSonicRepository<Dispose00>(db);
            }
            return _repo;        
        }       
        
        internal static IRepository<Dispose00> GetRepo(){
            return GetRepo("","");
        }
        
        public static Dispose00 SingleOrDefault(Expression<Func<Dispose00, bool>> expression) {

            var repo = GetRepo();
            var results=repo.Find(expression);
            Dispose00 single=null;
            if(results.Count() > 0){
        ...
        public static Dispose00 SingleOrDefault(Expression<Func<Dispose00, bool>> expression,string connectionString, string providerName) {
        ...
        public static bool Exists(Expression<Func<Dispose00, bool>> expression,string connectionString, string providerName) {
           
            return All(connectionString,providerName).Any(expression);
        }        
        public static bool Exists(Expression<Func<Dispose00, bool>> expression) {
           
            return All().Any(expression);
        }        

        public static IList<Dispose00> Find(Expression<Func<Dispose00, bool>> expression) {
            
            var repo = GetRepo();
            return repo.Find(expression).ToList();
        }
        
        public static IList<Dispose00> Find(Expression<Func<Dispose00, bool>> expression,string connectionString, string providerName) {

            var repo = GetRepo(connectionString,providerName);
            return repo.Find(expression).ToList();

        }
        public static IQueryable<Dispose00> All(string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetAll();
        }
        public static IQueryable<Dispose00> All() {
            return GetRepo().GetAll();
        }
        
        public static PagedList<Dispose00> GetPaged(string sortBy, int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(sortBy, pageIndex, pageSize);
        }
      
        public static PagedList<Dispose00> GetPaged(string sortBy, int pageIndex, int pageSize) {
            return GetRepo().GetPaged(sortBy, pageIndex, pageSize);
        }

        public static PagedList<Dispose00> GetPaged(int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(pageIndex, pageSize);
            
        }


        public static PagedList<Dispose00> GetPaged(int pageIndex, int pageSize) {
        ...
        public override bool Equals(object obj){
            if(obj.GetType()==typeof(Dispose00)){
                Dispose00 compare=(Dispose00)obj;
        ...
        public int DP_TYPE
        {
            ...
            set
            {
                if(_DP_TYPE!=value || _isLoaded){
                    _DP_TYPE=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="DP_TYPE");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
        ...
        public static void Delete(Expression<Func<Dispose00, bool>> expression) {
            var repo = GetRepo();
