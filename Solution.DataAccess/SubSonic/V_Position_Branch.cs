...
{    
    /// <summary>
    /// A class which represents the V_Position_Branch table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class V_Position_Branch: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<V_Position_Branch>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
		...
		public void ORMapping(IDataRecord dataRecord)
        {
            ...
            Expr1 = readRecord.get_string("Expr1",null);
