...
{    
    /// <summary>
    /// A class which represents the Material00 table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class Material00: IActiveRecord
    {
    
        #region Built-in testing
        static TestRepository<Material00> _testRepo;
        

        
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Material00>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        }
        public static void Setup(List<Material00> testlist){
            SetTestRepo();
        ...
        public static void Setup(Material00 item) {
            SetTestRepo();
            _testRepo._items.Add(item);
        }
        public static void Setup(int testItems) {
            ...
            for(int i=0;i<testItems;i++){
                Material00 item=new Material00();
                _testRepo._items.Add(item);
            }
        }
        ...
        public Material00(string connectionString, string providerName) {
        ...
        void Init(){
            ...
            if(TestMode){
                Material00.SetTestRepo();
                _repo=_testRepo;
            }else{
                _repo = new SubSonicRepository<Material00>(_db);
            }
            tbl=_repo.GetTable();
            SetIsNew(true);
            OnCreated();       
		...
		public void ORMapping(IDataRecord dataRecord)
        {
            ...
            MA_ID = readRecord.get_string("MA_ID",null);
            ...
            MAT_TYPE = readRecord.get_int("MAT_TYPE",null);
        ...
        public Material00(Expression<Func<Material00, bool>> expression):this() {
        ...
        internal static IRepository<Material00> GetRepo(string connectionString, string providerName){
            ...
            if(db.TestMode){
                ...
                _repo = new SubSonicRepository<Material00>(db);
            }
            return _repo;        
        }       
        
        internal static IRepository<Material00> GetRepo(){
            return GetRepo("","");
        }
        
        public static Material00 SingleOrDefault(Expression<Func<Material00, bool>> expression) {

            var repo = GetRepo();
            var results=repo.Find(expression);
            Material00 single=null;
            if(results.Count() > 0){
        ...
        public static Material00 SingleOrDefault(Expression<Func<Material00, bool>> expression,string connectionString, string providerName) {
        ...
        public static bool Exists(Expression<Func<Material00, bool>> expression,string connectionString, string providerName) {
           
            return All(connectionString,providerName).Any(expression);
        }        
        public static bool Exists(Expression<Func<Material00, bool>> expression) {
           
            return All().Any(expression);
        }        

        public static IList<Material00> Find(Expression<Func<Material00, bool>> expression) {
            
            var repo = GetRepo();
            return repo.Find(expression).ToList();
        }
        
        public static IList<Material00> Find(Expression<Func<Material00, bool>> expression,string connectionString, string providerName) {

            var repo = GetRepo(connectionString,providerName);
            return repo.Find(expression).ToList();

        }
        public static IQueryable<Material00> All(string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetAll();
        }
        public static IQueryable<Material00> All() {
            return GetRepo().GetAll();
        }
        
        public static PagedList<Material00> GetPaged(string sortBy, int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(sortBy, pageIndex, pageSize);
        }
      
        public static PagedList<Material00> GetPaged(string sortBy, int pageIndex, int pageSize) {
            return GetRepo().GetPaged(sortBy, pageIndex, pageSize);
        }

        public static PagedList<Material00> GetPaged(int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(pageIndex, pageSize);
            
        }


        public static PagedList<Material00> GetPaged(int pageIndex, int pageSize) {
        ...
        public override bool Equals(object obj){
            if(obj.GetType()==typeof(Material00)){
                Material00 compare=(Material00)obj;
        ...
        public string MA_ID
        {
            ...
            set
            {
                if(_MA_ID!=value || _isLoaded){
                    _MA_ID=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="MA_ID");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
        ...
        public int MAT_TYPE
        {
            ...
            set
            {
                if(_MAT_TYPE!=value || _isLoaded){
                    _MAT_TYPE=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="MAT_TYPE");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
        ...
        public static void Delete(Expression<Func<Material00, bool>> expression) {
            var repo = GetRepo();
