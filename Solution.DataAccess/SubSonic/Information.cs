...
{    
    /// <summary>
    /// A class which represents the Information table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class Information: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Information>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
		...
		public void ORMapping(IDataRecord dataRecord)
        {
            ...
            Note = readRecord.get_string("Note",null);
