...
namespace Solution.DataAccess.DataModel {
        ...
        public class ORDER_DEP01Structs: DatabaseTable {
            
            public ORDER_DEP01Structs(IDataProvider provider):base("ORDER_DEP01",provider){
                ClassName = "ORDER_DEP01";
                SchemaName = "dbo";
                ...
                Columns.Add(new DatabaseColumn("ORDDEP_ID", this)
                {
	                IsPrimaryKey = false,
            ...
            public IColumn ORDDEP_ID{
                get{
                    return this.GetColumn("ORDDEP_ID");
                }
            }
