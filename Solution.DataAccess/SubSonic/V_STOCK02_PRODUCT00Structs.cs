...
namespace Solution.DataAccess.DataModel {
        /// <summary>
        /// Table: V_STOCK02_PRODUCT00
        /// Primary Key: 
        /// </summary>

        public class V_STOCK02_PRODUCT00Structs: DatabaseTable {
            
            public V_STOCK02_PRODUCT00Structs(IDataProvider provider):base("V_STOCK02_PRODUCT00",provider){
                ClassName = "V_STOCK02_PRODUCT00";
                SchemaName = "dbo";
