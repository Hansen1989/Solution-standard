...
{    
    /// <summary>
    /// A class which represents the UploadConfig table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class UploadConfig: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<UploadConfig>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
