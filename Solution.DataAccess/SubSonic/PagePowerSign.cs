...
{    
    /// <summary>
    /// A class which represents the PagePowerSign table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class PagePowerSign: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<PagePowerSign>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
