...
{    
    /// <summary>
    /// A class which represents the Dispose01 table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class Dispose01: IActiveRecord
    {
    
        #region Built-in testing
        static TestRepository<Dispose01> _testRepo;
        

        
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Dispose01>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        }
        public static void Setup(List<Dispose01> testlist){
            SetTestRepo();
        ...
        public static void Setup(Dispose01 item) {
            SetTestRepo();
            _testRepo._items.Add(item);
        }
        ...
        public Dispose01(string connectionString, string providerName) {
        ...
        void Init(){
            ...
            if(TestMode){
                Dispose01.SetTestRepo();
                _repo=_testRepo;
            }else{
                _repo = new SubSonicRepository<Dispose01>(_db);
            }
            tbl=_repo.GetTable();
            SetIsNew(true);
            OnCreated();       
		...
		public void ORMapping(IDataRecord dataRecord)
        {
            ...
            DP_ID = readRecord.get_string("DP_ID",null);
            ...
            STD_QUAN = readRecord.get_double("STD_QUAN",null);
        ...
        public Dispose01(Expression<Func<Dispose01, bool>> expression):this() {
        ...
        internal static IRepository<Dispose01> GetRepo(string connectionString, string providerName){
            ...
            if(db.TestMode){
                ...
                _repo = new SubSonicRepository<Dispose01>(db);
            }
            return _repo;        
        }       
        
        internal static IRepository<Dispose01> GetRepo(){
            return GetRepo("","");
        }
        
        public static Dispose01 SingleOrDefault(Expression<Func<Dispose01, bool>> expression) {

            var repo = GetRepo();
            var results=repo.Find(expression);
            Dispose01 single=null;
            if(results.Count() > 0){
        ...
        public static Dispose01 SingleOrDefault(Expression<Func<Dispose01, bool>> expression,string connectionString, string providerName) {
        ...
        public static bool Exists(Expression<Func<Dispose01, bool>> expression,string connectionString, string providerName) {
           
            return All(connectionString,providerName).Any(expression);
        }        
        public static bool Exists(Expression<Func<Dispose01, bool>> expression) {
           
            return All().Any(expression);
        }        

        public static IList<Dispose01> Find(Expression<Func<Dispose01, bool>> expression) {
            
            var repo = GetRepo();
            return repo.Find(expression).ToList();
        }
        
        public static IList<Dispose01> Find(Expression<Func<Dispose01, bool>> expression,string connectionString, string providerName) {

            var repo = GetRepo(connectionString,providerName);
            return repo.Find(expression).ToList();

        }
        public static IQueryable<Dispose01> All(string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetAll();
        }
        public static IQueryable<Dispose01> All() {
            return GetRepo().GetAll();
        }
        
        public static PagedList<Dispose01> GetPaged(string sortBy, int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(sortBy, pageIndex, pageSize);
        }
      
        public static PagedList<Dispose01> GetPaged(string sortBy, int pageIndex, int pageSize) {
            return GetRepo().GetPaged(sortBy, pageIndex, pageSize);
        }

        public static PagedList<Dispose01> GetPaged(int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(pageIndex, pageSize);
            
        }


        public static PagedList<Dispose01> GetPaged(int pageIndex, int pageSize) {
        ...
        public override bool Equals(object obj){
            if(obj.GetType()==typeof(Dispose01)){
                Dispose01 compare=(Dispose01)obj;
        ...
        public string DP_ID
        {
            ...
            set
            {
                if(_DP_ID!=value || _isLoaded){
                    _DP_ID=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="DP_ID");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
        ...
        public static void Delete(Expression<Func<Dispose01, bool>> expression) {
            var repo = GetRepo();
