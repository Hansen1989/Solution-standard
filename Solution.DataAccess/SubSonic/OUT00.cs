...
{    
    /// <summary>
    /// A class which represents the OUT00 table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class OUT00: IActiveRecord
    {
    
        #region Built-in testing
        static TestRepository<OUT00> _testRepo;
        

        
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<OUT00>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        }
        public static void Setup(List<OUT00> testlist){
            SetTestRepo();
        ...
        public static void Setup(OUT00 item) {
            SetTestRepo();
            _testRepo._items.Add(item);
        }
        ...
        public OUT00(string connectionString, string providerName) {
        ...
        void Init(){
            ...
            if(TestMode){
                ...
                _repo = new SubSonicRepository<OUT00>(_db);
            }
            tbl=_repo.GetTable();
            SetIsNew(true);
            OnCreated();       
        ...
        public OUT00(Expression<Func<OUT00, bool>> expression):this() {
        ...
        internal static IRepository<OUT00> GetRepo(string connectionString, string providerName){
            ...
            if(db.TestMode){
                ...
                _repo = new SubSonicRepository<OUT00>(db);
            }
            return _repo;        
        }       
        
        internal static IRepository<OUT00> GetRepo(){
            return GetRepo("","");
        }
        
        public static OUT00 SingleOrDefault(Expression<Func<OUT00, bool>> expression) {
        ...
        public static OUT00 SingleOrDefault(Expression<Func<OUT00, bool>> expression,string connectionString, string providerName) {
        ...
        public static bool Exists(Expression<Func<OUT00, bool>> expression,string connectionString, string providerName) {
           
            return All(connectionString,providerName).Any(expression);
        }        
        public static bool Exists(Expression<Func<OUT00, bool>> expression) {
           
            return All().Any(expression);
        }        

        public static IList<OUT00> Find(Expression<Func<OUT00, bool>> expression) {
            
            var repo = GetRepo();
            return repo.Find(expression).ToList();
        }
        
        public static IList<OUT00> Find(Expression<Func<OUT00, bool>> expression,string connectionString, string providerName) {

            var repo = GetRepo(connectionString,providerName);
            return repo.Find(expression).ToList();

        }
        public static IQueryable<OUT00> All(string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetAll();
        }
        public static IQueryable<OUT00> All() {
            return GetRepo().GetAll();
        }
        
        public static PagedList<OUT00> GetPaged(string sortBy, int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(sortBy, pageIndex, pageSize);
        }
      
        public static PagedList<OUT00> GetPaged(string sortBy, int pageIndex, int pageSize) {
            return GetRepo().GetPaged(sortBy, pageIndex, pageSize);
        }

        public static PagedList<OUT00> GetPaged(int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(pageIndex, pageSize);
            
        }


        public static PagedList<OUT00> GetPaged(int pageIndex, int pageSize) {
        ...
        public override bool Equals(object obj){
            if(obj.GetType()==typeof(OUT00)){
                OUT00 compare=(OUT00)obj;
        ...
        public static void Delete(Expression<Func<OUT00, bool>> expression) {
            var repo = GetRepo();
