...
{    
    /// <summary>
    /// A class which represents the V_ORDERDEP02_PRODDEP table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class V_ORDERDEP02_PRODDEP: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<V_ORDERDEP02_PRODDEP>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
