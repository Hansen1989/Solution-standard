...
namespace Solution.DataAccess.DataModel {
        /// <summary>
        /// Table: V_Position_Branch
        /// Primary Key: 
        /// </summary>

        public class V_Position_BranchStructs: DatabaseTable {
            
            public V_Position_BranchStructs(IDataProvider provider):base("V_Position_Branch",provider){
                ClassName = "V_Position_Branch";
                SchemaName = "dbo";
