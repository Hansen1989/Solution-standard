...
{    
    /// <summary>
    /// A class which represents the RECEIVABLES01 table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class RECEIVABLES01: IActiveRecord
    {
    
        #region Built-in testing
        static TestRepository<RECEIVABLES01> _testRepo;
        ...
        public static void Setup(List<RECEIVABLES01> testlist){
            SetTestRepo();
        ...
        public static void Setup(RECEIVABLES01 item) {
            SetTestRepo();
            _testRepo._items.Add(item);
        }
        public static void Setup(int testItems) {
            ...
            for(int i=0;i<testItems;i++){
                RECEIVABLES01 item=new RECEIVABLES01();
                _testRepo._items.Add(item);
            }
        }
        ...
        IRepository<RECEIVABLES01> _repo;
        ITable tbl;
        bool _isNew;
        public bool IsNew(){
            return _isNew;
        ...
        public RECEIVABLES01(string connectionString, string providerName) {
        ...
        void Init(){
            ...
            if(TestMode){
                RECEIVABLES01.SetTestRepo();
                _repo=_testRepo;
            }else{
                _repo = new SubSonicRepository<RECEIVABLES01>(_db);
            }
            tbl=_repo.GetTable();
            SetIsNew(true);
            OnCreated();       
        ...
        public RECEIVABLES01(Expression<Func<RECEIVABLES01, bool>> expression):this() {
        ...
        internal static IRepository<RECEIVABLES01> GetRepo(string connectionString, string providerName){
            ...
            if(db.TestMode){
                ...
                _repo = new SubSonicRepository<RECEIVABLES01>(db);
            }
            return _repo;        
        }       
        
        internal static IRepository<RECEIVABLES01> GetRepo(){
            return GetRepo("","");
        }
        
        public static RECEIVABLES01 SingleOrDefault(Expression<Func<RECEIVABLES01, bool>> expression) {

            var repo = GetRepo();
            var results=repo.Find(expression);
            RECEIVABLES01 single=null;
            if(results.Count() > 0){
        ...
        public static RECEIVABLES01 SingleOrDefault(Expression<Func<RECEIVABLES01, bool>> expression,string connectionString, string providerName) {
        ...
        public static bool Exists(Expression<Func<RECEIVABLES01, bool>> expression,string connectionString, string providerName) {
           
            return All(connectionString,providerName).Any(expression);
        }        
        public static bool Exists(Expression<Func<RECEIVABLES01, bool>> expression) {
           
            return All().Any(expression);
        }        

        public static IList<RECEIVABLES01> Find(Expression<Func<RECEIVABLES01, bool>> expression) {
            
            var repo = GetRepo();
            return repo.Find(expression).ToList();
        }
        
        public static IList<RECEIVABLES01> Find(Expression<Func<RECEIVABLES01, bool>> expression,string connectionString, string providerName) {

            var repo = GetRepo(connectionString,providerName);
            return repo.Find(expression).ToList();

        }
        public static IQueryable<RECEIVABLES01> All(string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetAll();
        }
        public static IQueryable<RECEIVABLES01> All() {
            return GetRepo().GetAll();
        }
        
        public static PagedList<RECEIVABLES01> GetPaged(string sortBy, int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(sortBy, pageIndex, pageSize);
        }
      
        public static PagedList<RECEIVABLES01> GetPaged(string sortBy, int pageIndex, int pageSize) {
            return GetRepo().GetPaged(sortBy, pageIndex, pageSize);
        }

        public static PagedList<RECEIVABLES01> GetPaged(int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(pageIndex, pageSize);
            
        }


        public static PagedList<RECEIVABLES01> GetPaged(int pageIndex, int pageSize) {
        ...
        public override bool Equals(object obj){
            if(obj.GetType()==typeof(RECEIVABLES01)){
                RECEIVABLES01 compare=(RECEIVABLES01)obj;
        ...
        public static void Delete(Expression<Func<RECEIVABLES01, bool>> expression) {
            var repo = GetRepo();
