...
{    
    /// <summary>
    /// A class which represents the OnlineUsers table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class OnlineUsers: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<OnlineUsers>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
