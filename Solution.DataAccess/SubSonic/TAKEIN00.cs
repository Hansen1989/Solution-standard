...
{    
    /// <summary>
    /// A class which represents the TAKEIN00 table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class TAKEIN00: IActiveRecord
    {
    
        #region Built-in testing
        static TestRepository<TAKEIN00> _testRepo;
        

        
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<TAKEIN00>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        }
        public static void Setup(List<TAKEIN00> testlist){
            SetTestRepo();
        ...
        public static void Setup(TAKEIN00 item) {
            SetTestRepo();
            _testRepo._items.Add(item);
        }
        ...
        public TAKEIN00(string connectionString, string providerName) {
        ...
        void Init(){
            ...
            if(TestMode){
                TAKEIN00.SetTestRepo();
                _repo=_testRepo;
            }else{
                _repo = new SubSonicRepository<TAKEIN00>(_db);
            }
            tbl=_repo.GetTable();
            SetIsNew(true);
            OnCreated();       
		...
		public void ORMapping(IDataRecord dataRecord)
        {
            ...
            Memo = readRecord.get_byte("Memo",null);
        ...
        public TAKEIN00(Expression<Func<TAKEIN00, bool>> expression):this() {
        ...
        internal static IRepository<TAKEIN00> GetRepo(string connectionString, string providerName){
            ...
            if(db.TestMode){
                ...
                _repo = new SubSonicRepository<TAKEIN00>(db);
            }
            return _repo;        
        }       
        
        internal static IRepository<TAKEIN00> GetRepo(){
            return GetRepo("","");
        }
        
        public static TAKEIN00 SingleOrDefault(Expression<Func<TAKEIN00, bool>> expression) {

            var repo = GetRepo();
            var results=repo.Find(expression);
            TAKEIN00 single=null;
            if(results.Count() > 0){
        ...
        public static TAKEIN00 SingleOrDefault(Expression<Func<TAKEIN00, bool>> expression,string connectionString, string providerName) {
        ...
        public static bool Exists(Expression<Func<TAKEIN00, bool>> expression,string connectionString, string providerName) {
           
            return All(connectionString,providerName).Any(expression);
        }        
        public static bool Exists(Expression<Func<TAKEIN00, bool>> expression) {
           
            return All().Any(expression);
        }        

        public static IList<TAKEIN00> Find(Expression<Func<TAKEIN00, bool>> expression) {
            
            var repo = GetRepo();
            return repo.Find(expression).ToList();
        }
        
        public static IList<TAKEIN00> Find(Expression<Func<TAKEIN00, bool>> expression,string connectionString, string providerName) {

            var repo = GetRepo(connectionString,providerName);
            return repo.Find(expression).ToList();

        }
        public static IQueryable<TAKEIN00> All(string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetAll();
        }
        public static IQueryable<TAKEIN00> All() {
            return GetRepo().GetAll();
        }
        
        public static PagedList<TAKEIN00> GetPaged(string sortBy, int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(sortBy, pageIndex, pageSize);
        }
      
        public static PagedList<TAKEIN00> GetPaged(string sortBy, int pageIndex, int pageSize) {
            return GetRepo().GetPaged(sortBy, pageIndex, pageSize);
        }

        public static PagedList<TAKEIN00> GetPaged(int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(pageIndex, pageSize);
            
        }


        public static PagedList<TAKEIN00> GetPaged(int pageIndex, int pageSize) {
        ...
        public override bool Equals(object obj){
            if(obj.GetType()==typeof(TAKEIN00)){
                TAKEIN00 compare=(TAKEIN00)obj;
        ...
        public static void Delete(Expression<Func<TAKEIN00, bool>> expression) {
            var repo = GetRepo();
