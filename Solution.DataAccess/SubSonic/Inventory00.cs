...
{    
    /// <summary>
    /// A class which represents the Inventory00 table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class Inventory00: IActiveRecord
    {
    
        #region Built-in testing
        static TestRepository<Inventory00> _testRepo;
        

        
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Inventory00>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        }
        public static void Setup(List<Inventory00> testlist){
            SetTestRepo();
        ...
        public static void Setup(Inventory00 item) {
            SetTestRepo();
            _testRepo._items.Add(item);
        }
        public static void Setup(int testItems) {
            ...
            for(int i=0;i<testItems;i++){
                Inventory00 item=new Inventory00();
                _testRepo._items.Add(item);
            }
        }
        ...
        public Inventory00(string connectionString, string providerName) {
        ...
        void Init(){
            ...
            if(TestMode){
                Inventory00.SetTestRepo();
                _repo=_testRepo;
            }else{
                _repo = new SubSonicRepository<Inventory00>(_db);
            }
            tbl=_repo.GetTable();
            SetIsNew(true);
            OnCreated();       
        ...
        public Inventory00(Expression<Func<Inventory00, bool>> expression):this() {
        ...
        internal static IRepository<Inventory00> GetRepo(string connectionString, string providerName){
            ...
            if(db.TestMode){
                ...
                _repo = new SubSonicRepository<Inventory00>(db);
            }
            return _repo;        
        }       
        
        internal static IRepository<Inventory00> GetRepo(){
            return GetRepo("","");
        }
        
        public static Inventory00 SingleOrDefault(Expression<Func<Inventory00, bool>> expression) {

            var repo = GetRepo();
            var results=repo.Find(expression);
            Inventory00 single=null;
            if(results.Count() > 0){
        ...
        public static Inventory00 SingleOrDefault(Expression<Func<Inventory00, bool>> expression,string connectionString, string providerName) {
        ...
        public static bool Exists(Expression<Func<Inventory00, bool>> expression,string connectionString, string providerName) {
           
            return All(connectionString,providerName).Any(expression);
        }        
        public static bool Exists(Expression<Func<Inventory00, bool>> expression) {
           
            return All().Any(expression);
        }        

        public static IList<Inventory00> Find(Expression<Func<Inventory00, bool>> expression) {
            
            var repo = GetRepo();
            return repo.Find(expression).ToList();
        }
        
        public static IList<Inventory00> Find(Expression<Func<Inventory00, bool>> expression,string connectionString, string providerName) {

            var repo = GetRepo(connectionString,providerName);
            return repo.Find(expression).ToList();

        }
        public static IQueryable<Inventory00> All(string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetAll();
        }
        public static IQueryable<Inventory00> All() {
            return GetRepo().GetAll();
        }
        
        public static PagedList<Inventory00> GetPaged(string sortBy, int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(sortBy, pageIndex, pageSize);
        }
      
        public static PagedList<Inventory00> GetPaged(string sortBy, int pageIndex, int pageSize) {
            return GetRepo().GetPaged(sortBy, pageIndex, pageSize);
        }

        public static PagedList<Inventory00> GetPaged(int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(pageIndex, pageSize);
            
        }


        public static PagedList<Inventory00> GetPaged(int pageIndex, int pageSize) {
        ...
        public override bool Equals(object obj){
            if(obj.GetType()==typeof(Inventory00)){
                Inventory00 compare=(Inventory00)obj;
        ...
        public static void Delete(Expression<Func<Inventory00, bool>> expression) {
            var repo = GetRepo();
