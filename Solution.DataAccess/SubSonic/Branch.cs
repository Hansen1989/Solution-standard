...
{    
    /// <summary>
    /// A class which represents the Branch table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class Branch: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Branch>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
