...
namespace Solution.DataAccess.DataModel {
        ...
        public class Adjust00Structs: DatabaseTable {
            
            public Adjust00Structs(IDataProvider provider):base("Adjust00",provider){
                ClassName = "Adjust00";
                SchemaName = "dbo";
                ...
                Columns.Add(new DatabaseColumn("AD_ID", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = false,
                ...
                Columns.Add(new DatabaseColumn("ADJUST_TYPE", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.Int32,
	                IsNullable = false,
            ...
            public IColumn AD_ID{
                get{
                    return this.GetColumn("AD_ID");
                }
            }
            ...
            public IColumn ADJUST_TYPE{
                get{
                    return this.GetColumn("ADJUST_TYPE");
                }
            }
