...
namespace Solution.DataAccess.DataModel {
        ...
        public class V_Product01_PRCAREATable {
			/// <summary>
			/// 表名
			/// </summary>
			public static string TableName {
				get{
        			return "V_Product01_PRCAREA";
      			}
			}
			...
			/// 
			/// </summary>
   			public static string PRCAREA_NAME{
			      get{
        			return "PRCAREA_NAME";
      			}
		    }
			...
			/// 
			/// </summary>
   			public static string SUP_Return{
			      get{
        			return "SUP_Return";
      			}
		    }
			...
			/// 
			/// </summary>
   			public static string SUP_Return1{
			      get{
        			return "SUP_Return1";
      			}
		    }
			...
			/// 
			/// </summary>
   			public static string SUP_Return2{
			      get{
        			return "SUP_Return2";
      			}
		    }
			...
			/// 
			/// </summary>
   			public static string U_Ret_COST{
			      get{
        			return "U_Ret_COST";
      			}
		    }
			...
			/// 
			/// </summary>
   			public static string U_Ret_COST1{
			      get{
        			return "U_Ret_COST1";
      			}
		    }
			...
			/// 
			/// </summary>
   			public static string U_Ret_COST2{
			      get{
        			return "U_Ret_COST2";
      			}
		    }
			...
			/// 
			/// </summary>
   			public static string T_Ret_COST{
			      get{
        			return "T_Ret_COST";
      			}
		    }
			...
			/// 
			/// </summary>
   			public static string T_Ret_COST1{
			      get{
        			return "T_Ret_COST1";
      			}
		    }
			...
			/// 
			/// </summary>
   			public static string T_Ret_COST2{
			      get{
        			return "T_Ret_COST2";
      			}
		    }
			...
			/// 
			/// </summary>
   			public static string ORDER_UNIT{
			      get{
        			return "ORDER_UNIT";
      			}
		    }
			...
			/// 
			/// </summary>
   			public static string SAFE_QUAN{
			      get{
        			return "SAFE_QUAN";
      			}
		    }
