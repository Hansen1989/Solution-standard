...
namespace Solution.DataAccess.DataModel {
        ...
        public class Material00Structs: DatabaseTable {
            
            public Material00Structs(IDataProvider provider):base("Material00",provider){
                ClassName = "Material00";
                SchemaName = "dbo";
                ...
                Columns.Add(new DatabaseColumn("MA_ID", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = false,
                ...
                Columns.Add(new DatabaseColumn("MAT_TYPE", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.Int32,
	                IsNullable = false,
            ...
            public IColumn MA_ID{
                get{
                    return this.GetColumn("MA_ID");
                }
            }
            ...
            public IColumn MAT_TYPE{
                get{
                    return this.GetColumn("MAT_TYPE");
                }
            }
