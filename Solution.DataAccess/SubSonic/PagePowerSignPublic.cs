...
{    
    /// <summary>
    /// A class which represents the PagePowerSignPublic table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class PagePowerSignPublic: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<PagePowerSignPublic>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
