...
namespace Solution.DataAccess.DataModel
{
    public partial class SolutionDataBase_standardDB : IQuerySurface
    {
        ...
        public Query<DataAccess.Model.V_Purchase00_SHOP00> V_Purchase00_SHOP00 { get; set; }
        ...
        public Query<DataAccess.Model.V_TAKEIN10_SHOP00> V_TAKEIN10_SHOP00 { get; set; }
        public Query<DataAccess.Model.V_TAKEIN11_PRODUCT00> V_TAKEIN11_PRODUCT00 { get; set; }
        ...
        void Init()
        {
            ...
            V_Purchase00_SHOP00 = new Query<DataAccess.Model.V_Purchase00_SHOP00>(provider);
            ...
            V_TAKEIN10_SHOP00 = new Query<DataAccess.Model.V_TAKEIN10_SHOP00>(provider);
            V_TAKEIN11_PRODUCT00 = new Query<DataAccess.Model.V_TAKEIN11_PRODUCT00>(provider);
        	...
        	if(DataProvider.Schema.Tables.Count == 0)
			{
            	...
            	DataProvider.Schema.Tables.Add(new V_Purchase00_SHOP00Structs(DataProvider));
            	...
            	DataProvider.Schema.Tables.Add(new V_TAKEIN10_SHOP00Structs(DataProvider));
            	DataProvider.Schema.Tables.Add(new V_TAKEIN11_PRODUCT00Structs(DataProvider));
