...
{    
    /// <summary>
    /// A class which represents the WebConfig table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class WebConfig: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<WebConfig>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
