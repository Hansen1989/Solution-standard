...
namespace Solution.DataAccess.DataModel {
        ...
        public class Dispose01Structs: DatabaseTable {
            
            public Dispose01Structs(IDataProvider provider):base("Dispose01",provider){
                ClassName = "Dispose01";
                SchemaName = "dbo";
                ...
                Columns.Add(new DatabaseColumn("DP_ID", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = false,
            ...
            public IColumn DP_ID{
                get{
                    return this.GetColumn("DP_ID");
                }
            }
