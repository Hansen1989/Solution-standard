...
{    
    /// <summary>
    /// A class which represents the IN00 table in the SolutionDataBase_standard Database.
    /// </summary>
    public partial class IN00: IActiveRecord
    {
    
        #region Built-in testing
        static TestRepository<IN00> _testRepo;
        

        
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<IN00>(new Solution.DataAccess.DataModel.SolutionDataBase_standardDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        }
        public static void Setup(List<IN00> testlist){
            SetTestRepo();
        ...
        public static void Setup(IN00 item) {
            SetTestRepo();
            _testRepo._items.Add(item);
        }
        ...
        public IN00(string connectionString, string providerName) {
        ...
        void Init(){
            ...
            if(TestMode){
                ...
                _repo = new SubSonicRepository<IN00>(_db);
            }
            tbl=_repo.GetTable();
            SetIsNew(true);
            OnCreated();       
        ...
        public IN00(Expression<Func<IN00, bool>> expression):this() {
        ...
        internal static IRepository<IN00> GetRepo(string connectionString, string providerName){
            ...
            if(db.TestMode){
                ...
                _repo = new SubSonicRepository<IN00>(db);
            }
            return _repo;        
        }       
        
        internal static IRepository<IN00> GetRepo(){
            return GetRepo("","");
        }
        
        public static IN00 SingleOrDefault(Expression<Func<IN00, bool>> expression) {
        ...
        public static IN00 SingleOrDefault(Expression<Func<IN00, bool>> expression,string connectionString, string providerName) {
        ...
        public static bool Exists(Expression<Func<IN00, bool>> expression,string connectionString, string providerName) {
           
            return All(connectionString,providerName).Any(expression);
        }        
        public static bool Exists(Expression<Func<IN00, bool>> expression) {
           
            return All().Any(expression);
        }        

        public static IList<IN00> Find(Expression<Func<IN00, bool>> expression) {
            
            var repo = GetRepo();
            return repo.Find(expression).ToList();
        }
        
        public static IList<IN00> Find(Expression<Func<IN00, bool>> expression,string connectionString, string providerName) {

            var repo = GetRepo(connectionString,providerName);
            return repo.Find(expression).ToList();

        }
        public static IQueryable<IN00> All(string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetAll();
        }
        public static IQueryable<IN00> All() {
            return GetRepo().GetAll();
        }
        
        public static PagedList<IN00> GetPaged(string sortBy, int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(sortBy, pageIndex, pageSize);
        }
      
        public static PagedList<IN00> GetPaged(string sortBy, int pageIndex, int pageSize) {
            return GetRepo().GetPaged(sortBy, pageIndex, pageSize);
        }

        public static PagedList<IN00> GetPaged(int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(pageIndex, pageSize);
            
        }


        public static PagedList<IN00> GetPaged(int pageIndex, int pageSize) {
        ...
        public override bool Equals(object obj){
            if(obj.GetType()==typeof(IN00)){
                IN00 compare=(IN00)obj;
        ...
        public static void Delete(Expression<Func<IN00, bool>> expression) {
            var repo = GetRepo();
