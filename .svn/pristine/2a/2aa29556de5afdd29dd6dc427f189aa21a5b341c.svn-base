...
{
    public partial class ProdKindList : PageBase
    {
        ...
        public override void LoadData()
        {
            ...
            List<ConditionFun.SqlqueryCondition> conditionProdKindAllList = new List<ConditionFun.SqlqueryCondition>();
            //绑定Grid表格
            bll.BindGrid(Grid1, 0, 0, conditionProdKindAllList, sortList);
        ...
        public void Sort()
        {
            ...
            sortList.Add(PROD_KINDTable.Id);
        }
        #endregion
        ...
        protected void Grid1_PreRowDataBound(object sender, FineUI.GridPreRowEventArgs e)
        {
            ...
            if ((row).Row.Table.Rows[e.RowIndex][PROD_KINDTable.ISBOM].ToString() == "0")
            {
                var lbf = Grid1.FindColumn("ISBOM") as LinkButtonField;
            ...
            if ((row).Row.Table.Rows[e.RowIndex][PROD_KINDTable.ENABLE].ToString() == "0")
            {
        ...
        {
            Window1.IFrameUrl = "ProdKindEdit.aspx?" + MenuInfoBll.GetInstence().PageUrlEncryptString();
