...
namespace Solution.DataAccess.DataModel {
        ...
        public class Dispose00Structs: DatabaseTable {
            
            public Dispose00Structs(IDataProvider provider):base("Dispose00",provider){
                ClassName = "Dispose00";
                SchemaName = "dbo";
                ...
                Columns.Add(new DatabaseColumn("DP_TYPE", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.Int32,
	                IsNullable = false,
            ...
            public IColumn DP_TYPE{
                get{
                    return this.GetColumn("DP_TYPE");
                }
            }
