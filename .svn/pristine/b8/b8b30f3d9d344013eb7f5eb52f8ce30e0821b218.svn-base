...
namespace Solution.Logic.Managers
{
    ...
    public partial class UploadFileBll : LogicBase
    {
        ...
        public void Upload_UpdateRs(string rndKey, string joinName, int joinId)
        {
            ...
            wheres.Add(new ConditionFun.SqlqueryCondition(ConstraintType.And, UploadFileTable.RndKey, Comparison.Equals, rndKey));
        ...
        public string fix_PicSize(int vid)
        {
            ...
            //定义查询条件
            var wheres = new List<ConditionFun.SqlqueryCondition>();
            wheres.Add(new ConditionFun.SqlqueryCondition(ConstraintType.And, UploadFileTable.UploadConfig_Id, Comparison.Equals, vid));
            //定义排序
