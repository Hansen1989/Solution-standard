...
namespace Solution.Web.Managers.WebManage.Systems.Powers
{
    public partial class PagePowerSignList : PageBase
    {
        ...
        public void Sort()
        {
            ...
            sortList.Add(PagePowerSignTable.MenuInfo_Id + " asc");
        ...
        {
            Window1.IFrameUrl = "PagePowerSignEdit.aspx?" + MenuInfoBll.GetInstence().PageUrlEncryptString();
            Window1.Hidden = false;
        }
        #endregion
        ...
        public override void Edit()
        {
            ...
            Window1.IFrameUrl = "PagePowerSignEdit.aspx?Id=" + id + "&" + MenuInfoBll.GetInstence().PageUrlEncryptStringNoKey(id);
            Window1.Hidden = false;
        }
        #endregion
