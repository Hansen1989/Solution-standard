<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SuppliersList.aspx.cs" Inherits="Solution.Web.Managers.WebManage.Systems.DataCenter.SuppliersList" %>
...
<body>
    ...
    <f:panel id="Panel1" runat="server" title="厂商资料列表" enableframe="false" bodypadding="10px"
        enablecollapse="True">
        <toolbars>
        ...
        <items>
            <f:Grid ID="Grid1" Title="厂商列表" EnableFrame="false" EnableCollapse="true" AllowSorting="true" SortField="Depth" SortDirection="ASC" 
            ...
            OnPageIndexChange="Grid1_PageIndexChange" OnRowCommand="Grid1_RowCommand" OnPreRowDataBound="Grid1_PreRowDataBound" > 
                <Columns>
                    <f:RowNumberField />
                    <f:BoundField Width="180px" DataField="SUP_ID" HeaderText="厂商编号" />
                    <f:BoundField Width="180px" DataField="SUP_NAME" HeaderText="厂商名称" />
                    <f:BoundField Width="180px" DataField="SUP_NICKNAME" HeaderText="厂商简称" />
                    <f:BoundField Width="180px" DataField="SUP_TEL" HeaderText="厂商电话" />
                    <f:BoundField Width="180px" DataField="SUP_Email" HeaderText="厂商邮箱" />
                    <f:BoundField Width="180px" DataField="SUP_Contact" HeaderText="厂商联系人" />
                    <f:BoundField Width="180px" DataField="SUP_Mobile" HeaderText="联系人方式" />
                    <f:LinkButtonField HeaderText="操作" TextAlign="Center" ToolTip="点击修改当前记录" ExpandUnusedSpace="true" ColumnID="ButtonEdit" CommandName="ButtonEdit" />
                </Columns>
            </f:Grid>
