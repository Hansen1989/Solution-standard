...
namespace Solution.Web.Managers.WebManage.Systems.DataCenter
{
     ...
     public partial class GroupAreaList : PageBase
    {
        ...
        public void Sort()
        {
            ...
            sortList.Add(GROUPAREATable.Id + " asc");
        ...
        {
            Window1.IFrameUrl = "GroupAreaEdit.aspx?" + MenuInfoBll.GetInstence().PageUrlEncryptString();
            Window1.Hidden = false;
        }
        #endregion
        ...
        public override void Edit()
        {
            ...
            Window1.IFrameUrl = "GroupAreaEdit.aspx?Id=" + id + "&" + MenuInfoBll.GetInstence().PageUrlEncryptStringNoKey(id);
            Window1.Hidden = false;
        }
        #endregion
