...
namespace Solution.DataAccess.DataModel {
        ...
        public class COMPONENT01Structs: DatabaseTable {
            
            public COMPONENT01Structs(IDataProvider provider):base("COMPONENT01",provider){
                ...
                Columns.Add(new DatabaseColumn("DETAIL_ID", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.Int32,
	                IsNullable = false,
                ...
                Columns.Add(new DatabaseColumn("LQUANTITY", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.Decimal,
	                IsNullable = false,
	                ...
	                IsForeignKey = false,
	                MaxLength = 0,
					PropertyName = "LQUANTITY"
                });

                Columns.Add(new DatabaseColumn("New_PROD_ID", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = true,
                ...
                Columns.Add(new DatabaseColumn("PrtTag", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.Byte,
	                IsNullable = false,
            ...
            public IColumn DETAIL_ID{
                get{
                    return this.GetColumn("DETAIL_ID");
                }
            }
            ...
            public IColumn LQUANTITY{
                get{
                    return this.GetColumn("LQUANTITY");
                }
            }
				
            
            public IColumn New_PROD_ID{
                get{
                    return this.GetColumn("New_PROD_ID");
                }
            }
            ...
            public IColumn PrtTag{
                get{
                    return this.GetColumn("PrtTag");
                }
            }
