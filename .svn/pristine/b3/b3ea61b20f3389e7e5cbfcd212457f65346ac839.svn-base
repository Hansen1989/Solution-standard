<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PagePowerSignList.aspx.cs" Inherits="Solution.Web.Managers.WebManage.Systems.Powers.PagePowerSignList" %>
    ...
    <f:panel id="Panel1" runat="server" title="菜单(页面)列表" enableframe="false" bodypadding="10px"
        ...
        <items>
             <f:SimpleForm ID="SimpleForm1" BodyPadding="5px" runat="server" EnableFrame="false" EnableCollapse="true"
                ...
                <Items>
                    <f:DropDownList Label="菜单选择" runat="server" ID="ddlParentId" Width="300px" ></f:DropDownList>
                </Items>
            </f:SimpleForm>
            <f:Grid ID="Grid1" Title="页面权限设置" EnableFrame="false" EnableCollapse="true" AllowSorting="true" SortField="Depth" SortDirection="ASC" 
           ...
           OnPageIndexChange="Grid1_PageIndexChange">  <%--   OnRowCommand="Grid1_RowCommand" OnPreRowDataBound="Grid1_PreRowDataBound"--%>  
                <Columns>
                    <f:RowNumberField />
                    <f:BoundField Width="180px" DataField="Id" DataFormatString="{0}" HeaderText="页面ID" />
                    <f:BoundField Width="180px" DataField="PagePowerSignPublic_Id" DataFormatString="{0}" HeaderText="公共表ID" />
                    <f:BoundField Width="180px" DataField="CName" DataFormatString="{0}" HeaderText="中文名称" />
                    <f:BoundField Width="180px" DataField="EName" DataFormatString="{0}" HeaderText="英名名称" />
                    <f:BoundField Width="180px" DataField="MenuInfo_Id" DataFormatString="{0}" HeaderText="菜单ID" />
