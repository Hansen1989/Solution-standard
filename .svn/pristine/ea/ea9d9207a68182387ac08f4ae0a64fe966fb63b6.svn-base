<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PositionList.aspx.cs" Inherits="Solution.Web.Managers.WebManage.Systems.SysAuthority.PositionList" %>
...
<body>
   <form id="form1" runat="server">
    <f:pagemanager id="PageManager1" runat="server" /> <%--AutoSizePanelID="Panel1,Grid1"  --%>
    <f:panel id="Panel1" runat="server" title="用户信息管理" enableframe="false" bodypadding="10px"  
        enablecollapse="True">
        <toolbars>
       ...
       <f:Grid ID="Grid1" Title="职位管理" EnableFrame="false" EnableCollapse="true" AllowSorting="true" SortField="Depth" SortDirection="ASC" ForceFit="False" 
           ...
           AutoScroll="True" OnRowCommand="Grid1_RowCommand" OnPreRowDataBound="Grid1_PreRowDataBound">  <%-- OnPageIndexChange="Grid1_PageIndexChange"  --%>  
                <Columns>
                    <f:RowNumberField />
                    <f:BoundField Width="180px" DataField="Name" DataFormatString="{0}" HeaderText="职位名称" />
                   ...
                   <%-- <f:TemplateField HeaderText="排序" Width="100px">
                    ...
                    <f:BoundField Width="180px" DataField="Branch_Code" DataFormatString="{0}" HeaderText="部门编码" />
                    <%--<f:BoundField Width="180px" DataField="Branch_Name" DataFormatString="{0}" HeaderText="部门名称" />--%>
                 <%--   <f:BoundField Width="180px" DataField="PagePower" DataFormatString="{0}" HeaderText="菜单操作权限" />
                    <f:BoundField Width="180px" DataField="ControlPower" DataFormatString="{0}" HeaderText="页面功能操作权限" />
                    <f:BoundField Width="180px" DataField="IsSetBranchPower" DataFormatString="{0}" HeaderText="是否有操作指定部门权限" />--%>
                    <%--<f:BoundField Width="180px" DataField="SetBranchCode" DataFormatString="{0}" HeaderText="部门编号" />--%>
                    <f:LinkButtonField HeaderText="详情" TextAlign="Center" ToolTip="点击当前记录" ColumnID="ButtonEdit" CommandName="ButtonEdit" />
