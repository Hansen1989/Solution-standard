...
namespace Solution.Web.Managers.WebManage.Systems.ProductionCenter
{
     ...
     public partial class ProductionControlList : PageBase
    {
        ...
        {
            Window1.IFrameUrl = "ProductionPlanEdit.aspx?" + MenuInfoBll.GetInstence().PageUrlEncryptString();
            Window1.Hidden = false;
        }
        #endregion
        ...
        public override void Edit()
        {
            ...
            Window1.IFrameUrl = "ProductionPlanEdit.aspx?Id=" + id + "&" + MenuInfoBll.GetInstence().PageUrlEncryptStringNoKey(id);
            Window1.Hidden = false;
        }
        #endregion
