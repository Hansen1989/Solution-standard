...
{
    public partial class StockList : PageBase
    {
        ...
        {
            //逻辑对象赋值
            bll = STOCK_SHOP00Bll.GetInstence();
        ...
        {
            Window1.IFrameUrl = "StockEdit.aspx?" + MenuInfoBll.GetInstence().PageUrlEncryptString();
        ...
        public override void Edit()
        {
            ...
            Window1.IFrameUrl = "StockEdit.aspx?Id=" + id + "&" + MenuInfoBll.GetInstence().PageUrlEncryptStringNoKey(id);
            Window1.Hidden = false;
        }
        #endregion
