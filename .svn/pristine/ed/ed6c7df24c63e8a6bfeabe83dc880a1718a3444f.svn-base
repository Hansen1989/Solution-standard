...
namespace Solution.DataAccess.DataModel {
        ...
        public class PROD_UNITStructs: DatabaseTable {
            
            public PROD_UNITStructs(IDataProvider provider):base("PROD_UNIT",provider){
                ClassName = "PROD_UNIT";
                SchemaName = "dbo";
                ...
                Columns.Add(new DatabaseColumn("UNIT_ID", this)
                {
	                IsPrimaryKey = false,
                ...
                Columns.Add(new DatabaseColumn("UNIT_MEMO", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = true,
            ...
            public IColumn UNIT_ID{
                get{
                    return this.GetColumn("UNIT_ID");
                }
            }
            ...
            public IColumn UNIT_MEMO{
                get{
                    return this.GetColumn("UNIT_MEMO");
                }
            }
