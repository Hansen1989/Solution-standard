<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProdUnitListEdit.aspx.cs" Inherits="Solution.Web.Managers.WebManage.Systems.DataCenter.ProdUnitListEdit" %>
            ...
            <f:Panel ID="Panel2" runat="server" EnableFrame="false" BodyPadding="5px" EnableCollapse="True" ShowHeader="False" ShowBorder="False">
                <Items>
                    <f:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false"
                        ...
                        <Items>
                            <f:TextBox runat="server" Label="计量单位编码" ID="UNIT_ID" ShowRedStar="true" Width="250px"></f:TextBox>
                            <f:TextBox runat="server" Label="计量单位名称" ID="UNIT_NAME" ShowRedStar="true" Width="250px"></f:TextBox>
                            <f:TextBox runat="server" Label="计量单位备注" ID="UNIT_MENO" Width="400px"></f:TextBox>
