...
namespace Solution.DataAccess.DataModel {
        ...
        public class TAKEIN10Structs: DatabaseTable {
            
            public TAKEIN10Structs(IDataProvider provider):base("TAKEIN10",provider){
                ClassName = "TAKEIN10";
                SchemaName = "dbo";
                ...
                Columns.Add(new DatabaseColumn("INVOICE_ID", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = true,
            ...
            public IColumn INVOICE_ID{
                get{
                    return this.GetColumn("INVOICE_ID");
                }
            }
